...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of ZUICollectionViewHeaderHoveringFlowLayout.'
...
TODO: Add long description of the pod here.
  ...
  # s.resource_bundles = {
  #   'ZUICollectionViewHeaderHoveringFlowLayout' => ['ZUICollectionViewHeaderHoveringFlowLayout/Assets/*.png']
  # }
